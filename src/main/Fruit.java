...
public class Fruit extends GameObject{
	...
	private int changeSpeed = 51;
	
	
	public Fruit(float x, float y, ID id, Color color) {
		super(x+5, y, id);
	...
	public void render(Graphics g) {
		...
		if (Game.RENDERBUBBLE){
			...
			g2d.fillOval((int)x, (int)y+22, (int)WIDTH/2, (int)HEIGHT/2-3);
			g2d.fillOval((int)x+13, (int)y+28, (int)WIDTH/2, (int)HEIGHT/2-3);
			g2d.drawImage(Initialize.fruit, (int)x, (int)y, null);
		}
	}
